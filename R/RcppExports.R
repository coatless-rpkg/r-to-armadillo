...
seq_default <- function(from, to, length_out) {
    .Call('r2arma_seq_default', PACKAGE = 'r2arma', from, to, length_out)
}
...
seq_default_a <- function(a, length_out) {
    .Call('r2arma_seq_default_a', PACKAGE = 'r2arma', a, length_out)
}
...
seq_along_cpp <- function(along_with) {
    .Call('r2arma_seq_along_cpp', PACKAGE = 'r2arma', along_with)
}
...
seq_len_cpp <- function(length_out) {
    .Call('r2arma_seq_len_cpp', PACKAGE = 'r2arma', length_out)
}
